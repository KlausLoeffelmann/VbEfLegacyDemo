...
Namespace Migrations
    ...
    Public NotInheritable Partial Class InitialDbSchema
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(InitialDbSchema))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201801301650417_InitialDbSchema"
            End Get
        End Property
